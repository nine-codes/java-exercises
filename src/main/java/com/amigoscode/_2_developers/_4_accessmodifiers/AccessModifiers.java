...
public class AccessModifiers {
    ...
    public String demonstrateInternalAccess() {
        ...
        String greetPublicly = publicGreeting();
        String greetProtected = protectedGreeting();
        String greetPackage = packageGreeting();

        return String.format("%s,\n%s,\n%s,\n%s", secret, greetPublicly, greetProtected, greetPackage);
    }
