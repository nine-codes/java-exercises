...
public class PackageDemo {
    ...
    public static void useListFromUtil() {
        ...
        List<String> list = new ArrayList<String>(List.of("Apple", "Banana", "Cherry"));

        // list.forEach(fruit -> System.out.println(fruit));
        //TIP we can log items directly by method reference instead of passing the argument in
    ...
    public static void useFullyQualifiedName() {
        ...
        map.put("Alice", 90);
        map.put("Bob", 85);
        //TIP we can make it easier/quicker by bulk putting them right away;
        // map.putAll(Map.of("Alice", 90, "Bob", 85));
